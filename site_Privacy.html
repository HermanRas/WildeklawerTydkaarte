...
<body>
    ...
    <p>At Wildeklawerapps, accessible from www.Wildeklawerapps.co.za, one of our main priorities is the privacy of our
        visitors.
        This Privacy Policy document contains types of information that is collected and recorded by Wildeklawerapps and
        how
        we use it.</p>
    ...
    <p>Wildeklawerapps follows a standard procedure of using log files. These files log visitors when they visit
        websites.
    ...
    <p>Like any other website, Wildeklawerapps uses 'cookies'. These cookies are used to store information including
    ...
    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Wildeklawerapps. Our
    ...
    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on Wildeklawerapps, which are sent directly to users'
        browser.
    ...
    <p>Note that Wildeklawerapps has no access to or control over these cookies that are used by third-party
        advertisers.
    </p>

    <h2>Third Party Privacy Policies</h2>

    <p>Wildeklawerapps's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
    ...
    <p>Wildeklawerapps does not knowingly collect any Personal Identifiable Information from children under the age of
        13.
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
        to the information that they shared and/or collect in Wildeklawerapps. This policy is not applicable to any
